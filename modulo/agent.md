---
description: Agente conversacional que lee, valida y crea órdenes de compra en SAP a partir de solicitud, cotización y aprobación por correo; nunca inventa un dato y se detiene a pedir confirmación humana cuando corresponde.
mode: primary
permission:
  edit: deny
  bash: deny
